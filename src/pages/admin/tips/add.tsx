...
import { createCareTip } from "../../../graphql/mutations";
...
export const getServerSideProps: GetServerSideProps = async () => {
  ...
  const categories = resp.data.listCareTipCategorys.items;
...
const AdminTipAdd: NextPage<{ categories: any[] }> = ({ categories }) => {
...
export default WithAdminAuth(AdminTipAdd);
